...
import { Local_trListener } from "./Local_trListener";
export declare class Local_trParser extends Parser {
...
export declare class LangContext extends ParserRuleContext {
    ...
    enterRule(listener: Local_trListener): void;
    exitRule(listener: Local_trListener): void;
}
