...
class Local_trParser extends Parser_1.Parser {
    constructor(input) {
        super(input);
        this._interp = new ParserATNSimulator_1.ParserATNSimulator(Local_trParser._ATN, this);
    }
    // @Override
    // @NotNull
    get vocabulary() {
    ...
    // @Override
    get ruleNames() { return Local_trParser.ruleNames; }
    // @Override
    get serializedATN() { return Local_trParser._serializedATN; }
    // @RuleVersion(0)
    lang() {
    ...
    static get _ATN() {
        if (!Local_trParser.__ATN) {
            Local_trParser.__ATN = new ATNDeserializer_1.ATNDeserializer().deserialize(Utils.toCharArray(Local_trParser._serializedATN));
        }
        return Local_trParser.__ATN;
    }
}
Local_trParser.COMMAND_WRITE = 1;
Local_trParser.COMMAND_READ = 2;
Local_trParser.COMMAND_FUNC = 3;
Local_trParser.COMMAND_CALL = 4;
Local_trParser.COMMAND_IF = 5;
Local_trParser.COMMAND_ELSE = 6;
Local_trParser.COMMAND_WHILE = 7;
Local_trParser.BOOL_EQ = 8;
Local_trParser.BOOL_GT = 9;
Local_trParser.BOOL_LT = 10;
Local_trParser.BOOL_TRUE = 11;
Local_trParser.BOOL_FALSE = 12;
Local_trParser.MUL = 13;
Local_trParser.DIV = 14;
Local_trParser.ADD = 15;
Local_trParser.SUB = 16;
Local_trParser.VARIABLE = 17;
Local_trParser.NUMBER = 18;
Local_trParser.STRING = 19;
Local_trParser.COMMENT = 20;
Local_trParser.TEXT = 21;
Local_trParser.QUOTE = 22;
Local_trParser.EOL = 23;
Local_trParser.WS = 24;
Local_trParser.RULE_lang = 0;
Local_trParser.RULE_block = 1;
Local_trParser.RULE_command = 2;
Local_trParser.RULE_command_print = 3;
Local_trParser.RULE_command_read = 4;
Local_trParser.RULE_command_assign = 5;
Local_trParser.RULE_command_block_func = 6;
Local_trParser.RULE_command_call = 7;
Local_trParser.RULE_command_block_if = 8;
Local_trParser.RULE_command_block_else = 9;
Local_trParser.RULE_command_block_while = 10;
Local_trParser.RULE_math_arg = 11;
Local_trParser.RULE_bool_arg = 12;
Local_trParser.RULE_command_arg = 13;
// tslint:disable:no-trailing-whitespace
Local_trParser.ruleNames = [
...
Local_trParser._SYMBOLIC_NAMES = [
...
Local_trParser.VOCABULARY = new VocabularyImpl_1.VocabularyImpl(Local_trParser._LITERAL_NAMES, Local_trParser._SYMBOLIC_NAMES, []);
Local_trParser._serializedATN = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x03\x1A\x80\x04\x02" +
    ...
    "\x02\x11!),/18;ACL[iqs{";
exports.Local_trParser = Local_trParser;
class LangContext extends ParserRuleContext_1.ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return Local_trParser.RULE_lang; }
    // @Override
    enterRule(listener) {
...
class BlockContext extends ParserRuleContext_1.ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return Local_trParser.RULE_block; }
    // @Override
    enterRule(listener) {
...
class CommandContext extends ParserRuleContext_1.ParserRuleContext {
    COMMENT() { return this.tryGetToken(Local_trParser.COMMENT, 0); }
    command_call() {
    ...
    EOL() { return this.tryGetToken(Local_trParser.EOL, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return Local_trParser.RULE_command; }
    // @Override
    enterRule(listener) {
...
class Command_printContext extends ParserRuleContext_1.ParserRuleContext {
    COMMAND_WRITE() { return this.getToken(Local_trParser.COMMAND_WRITE, 0); }
    command_arg(i) {
        if (i === undefined) {
    ...
    // @Override
    get ruleIndex() { return Local_trParser.RULE_command_print; }
    // @Override
    enterRule(listener) {
...
class Command_readContext extends ParserRuleContext_1.ParserRuleContext {
    COMMAND_READ() { return this.getToken(Local_trParser.COMMAND_READ, 0); }
    VARIABLE() { return this.getToken(Local_trParser.VARIABLE, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return Local_trParser.RULE_command_read; }
    // @Override
    enterRule(listener) {
...
class Command_assignContext extends ParserRuleContext_1.ParserRuleContext {
    ...
    // @Override
    get ruleIndex() { return Local_trParser.RULE_command_assign; }
    // @Override
    enterRule(listener) {
...
class Command_block_funcContext extends ParserRuleContext_1.ParserRuleContext {
    COMMAND_FUNC() { return this.getToken(Local_trParser.COMMAND_FUNC, 0); }
    VARIABLE() { return this.getToken(Local_trParser.VARIABLE, 0); }
    EOL() { return this.getToken(Local_trParser.EOL, 0); }
    block() {
    ...
    // @Override
    get ruleIndex() { return Local_trParser.RULE_command_block_func; }
    // @Override
    enterRule(listener) {
...
class Command_callContext extends ParserRuleContext_1.ParserRuleContext {
    COMMAND_CALL() { return this.getToken(Local_trParser.COMMAND_CALL, 0); }
    VARIABLE() { return this.getToken(Local_trParser.VARIABLE, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return Local_trParser.RULE_command_call; }
    // @Override
    enterRule(listener) {
...
class Command_block_ifContext extends ParserRuleContext_1.ParserRuleContext {
    COMMAND_IF() { return this.getToken(Local_trParser.COMMAND_IF, 0); }
    bool_arg() {
    ...
    // @Override
    get ruleIndex() { return Local_trParser.RULE_command_block_if; }
    // @Override
    enterRule(listener) {
...
class Command_block_elseContext extends ParserRuleContext_1.ParserRuleContext {
    COMMAND_ELSE() { return this.getToken(Local_trParser.COMMAND_ELSE, 0); }
    EOL() { return this.getToken(Local_trParser.EOL, 0); }
    block() {
        return this.getRuleContext(0, BlockContext);
    }
    ...
    // @Override
    get ruleIndex() { return Local_trParser.RULE_command_block_else; }
    // @Override
    enterRule(listener) {
...
class Command_block_whileContext extends ParserRuleContext_1.ParserRuleContext {
    COMMAND_WHILE() { return this.getToken(Local_trParser.COMMAND_WHILE, 0); }
    bool_arg() {
        return this.getRuleContext(0, Bool_argContext);
    }
    EOL() { return this.getToken(Local_trParser.EOL, 0); }
    ...
    // @Override
    get ruleIndex() { return Local_trParser.RULE_command_block_while; }
    // @Override
    enterRule(listener) {
...
class Math_argContext extends ParserRuleContext_1.ParserRuleContext {
    ...
    MUL() { return this.tryGetToken(Local_trParser.MUL, 0); }
    DIV() { return this.tryGetToken(Local_trParser.DIV, 0); }
    ADD() { return this.tryGetToken(Local_trParser.ADD, 0); }
    SUB() { return this.tryGetToken(Local_trParser.SUB, 0); }
    NUMBER() { return this.tryGetToken(Local_trParser.NUMBER, 0); }
    VARIABLE() { return this.tryGetToken(Local_trParser.VARIABLE, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return Local_trParser.RULE_math_arg; }
    // @Override
    enterRule(listener) {
...
class Bool_argContext extends ParserRuleContext_1.ParserRuleContext {
    ...
    BOOL_EQ() { return this.tryGetToken(Local_trParser.BOOL_EQ, 0); }
    BOOL_GT() { return this.tryGetToken(Local_trParser.BOOL_GT, 0); }
    BOOL_LT() { return this.tryGetToken(Local_trParser.BOOL_LT, 0); }
    BOOL_TRUE() { return this.tryGetToken(Local_trParser.BOOL_TRUE, 0); }
    BOOL_FALSE() { return this.tryGetToken(Local_trParser.BOOL_FALSE, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return Local_trParser.RULE_bool_arg; }
    // @Override
    enterRule(listener) {
...
class Command_argContext extends ParserRuleContext_1.ParserRuleContext {
    VARIABLE() { return this.tryGetToken(Local_trParser.VARIABLE, 0); }
    STRING() { return this.tryGetToken(Local_trParser.STRING, 0); }
    NUMBER() { return this.tryGetToken(Local_trParser.NUMBER, 0); }
    constructor(parent, invokingState) {
        super(parent, invokingState);
    }
    // @Override
    get ruleIndex() { return Local_trParser.RULE_command_arg; }
    // @Override
    enterRule(listener) {
...
//# sourceMappingURL=Local_trParser.js.map